...
source /home/nuc/rose_nav/install/setup.bash

btstop(){
. /home/nuc/sentry_brain/setup_service.sh stop
}
btstart()
{
. /home/nuc/sentry_brain/setup_service.sh start
}
btlog(){
. /home/nuc/sentry_brain/setup_service.sh journal
}
navtest()
{
ros2 launch bringup_nav rm_sentry_reality_launch.py use_rviz:=True
}
nav()
{
 ros2 launch bringup_nav rm_sentry_reality_launch.py use_rviz:=True world:=rmul_2026
}
bt()
{
sudo  /home/nuc/sentry_brain/run.sh run rmul_2026
}
a()
{
sudo  /home/nuc/sentry_brain/run.sh run rmul_2026
